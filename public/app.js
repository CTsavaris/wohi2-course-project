    ...
    if (questions.length === 0) {
      ...
      html += questions
        ...
        <article class="question-card ${q[CONFIG.API_FIELDS.SOLVED] ? "solved-card" : ""}">
          <h3>
            <a href="#" class="question-link" data-id="${q.id}">${q.title}</a>
  ...
  try {
    ...
    container.innerHTML = `
      ...
      <article class="question-card question-detail">
        <h3>${q.title} ${q[CONFIG.API_FIELDS.SOLVED] ? `<span class="badge-solved">Solved</span>` : ""}</h3>
    ...
    <div class="question-form-wrapper">
      ...
      <form id="question-form" enctype="multipart/form-data">
        <div class="form-group">
          ...
          <input type="text" id="q-question" value="${q.title || ""}" required />
        </div>
        <div class="form-group">
  ...
  try {
    ...
    container.innerHTML = `
      ...
      <div class="question-form-wrapper" style="text-align:center">
        <div class="play-question-text">${q.title}</div>
    ...
    document.getElementById("play-form").addEventListener("submit", async (e) => {
      ...
      try {
        ...
        if (result.correct) {
          resultEl.innerHTML = `
            <div class="play-result correct">Correct! <span class="badge-solved">Solved</span></div>`;
